				...
				<div class="card">
					<div class="card-body">
						...
						<div class="table-responsive">
							...
							@endif
							<form class="m-t-40"   method="POST" action="{{ route('preparator-documentupdate') }}" enctype="multipart/form-data">
								@csrf
								...
								<div class="form-group">
									...
									<div class="controls">
										 <input type="file" required name="document" class="form-control" value="{{old('document') }}" > 
