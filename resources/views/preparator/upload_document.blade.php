				...
				<div class="card">
					<div class="card-body">
						...
						<div class="table-responsive">
							...
							@endif
							<form class="m-t-40"   method="POST" action="{{ route('store-document') }}" enctype="multipart/form-data">
								@csrf
								<input type="hidden" name="user_id"  value="{{Auth::user()->id}}" required > 
								<div class="form-group">
									
									<input type="hidden" name="department" value="{{$my_dept->id}}" required>
								...
								<div class="form-group">
									...
									<div class="controls">
										 <input type="file" name="document" class="form-control" value="{{old('document') }}"  required> 
										 <div class="help-block"></div>
									</div>
								</div>
