...
<title>{{ config('app.name', 'Preparator') }}</title>
			...
			<div class="scroll-sidebar" >
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li>
							<a class="has-arrow waves-effect waves-dark" href="{{ route('preparator-document') }}" aria-expanded="false"><i class=" fa fa-address-book-o"></i><span class="hide-menu">My Prepared Document- Approval Status </span></a>
						</li>
						<li><a href="{{route('upload-document')}}">Upload New Document</a></li>
						<li><a href="#">In My Dept-Approved Documents</a></li>
						<li><a href="#">Common-Approved Documents</a></li>
					</ul>
