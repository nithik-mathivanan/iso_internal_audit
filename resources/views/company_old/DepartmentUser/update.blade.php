...
<div class="page-wrapper">
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor">Department User</h3>
		</div>
	</div>
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">Edit Department User</h4>
						<div class="table-responsive">
						@foreach($user as $companyuser)
							<form class="m-t-40"   method="POST" action="{{ route('companydepartmentusereditupdate') }}">
								@csrf                   
