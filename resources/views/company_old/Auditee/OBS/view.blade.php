...
<div class="page-wrapper">
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor">OBS View</h3>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">OBS</h4>
						<h6 class="card-subtitle"></h6>
						<div class="table-responsive">
							<table id="OBSview-grid" class="table m-t-30 table-hover contact-list" data-page-size="10">
								<thead>
									<tr>
										<th>Observation</th>
										<th>OBS Report</th>
...
<script type="text/javascript">
	$(function() {
		...
		$('#OBSview-grid').DataTable({
		processing: true,
		serverSide: true,
			ajax:{
				url:'../AuditeeOBSviewdetail/{{request()->AuditPlanNo}}',
			},
			columns: [
			
			{ data: 'observation', name: 'observation' },
			{ data: 'obsreport', name: 'obsreport' },
...
<div id="myModal" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
				<div class="modal-header"><h4 class="card-title">OBSERVATION REPORT </h4>
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				</div>
				<div class="modal-body">
					<form class="" id="form" >
						
				<input name="OBSNO" value="" id="OBSNO" style="display:none">
				<input name="AuditPlanNo" value="" id="AuditPlanNo"  style="display:none">
						...
						<div class="table-responsive"><table class="table color-table success-table" style="font-size:10px; ">
								<thead class="border">
									<tr  >
										<th  colspan="8" class="reporttable9  " >DEPARTMENT /PROCESS OBSERVATION (OBS) REPORT</th>
									</tr>
								</thead>
								<tbody>
									...
									<div style="float:left;">Observation Description:  
...
<script>  
	 $(document).on('click', '.addAttr', function(){  
           var OBSNO = $(this).attr("id");  $(".modal-body #OBSNO").val(OBSNO);
