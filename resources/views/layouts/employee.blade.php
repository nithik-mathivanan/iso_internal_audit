...
<div id="wrapper">
    ...
    <div class="top-left-part">
        <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a class="logo hidden-xs hidden-sm text-center" href="#">ISO
    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li><a href="{{ route('employee') }}" class="waves-effect"><i class="icon-speedometer fa-fw"></i> <span class="hide-menu">Dashboard </span></a> </li>

             <li><a href="{{ route('employee.client.index') }}" class="waves-effect"><i class="icon-people fa-fw"></i> <span class="hide-menu">Customers<span class="fa arrow"></span> </span></a>
                    <ul class="nav nav-second-level">
                    <li><a href="{{ route('employee.client.index') }}" class="waves-effect">Client List</a> </li>
                    </ul>
                </li>
           
             <li><a href="{{ route('employee.employees.index') }}" class="waves-effect"><i class="ti-user fa-fw"></i> <span class="hide-menu">HR<span class="fa arrow"></span> </span></a>
                    <ul class="nav nav-second-level">
                     <li><a href="{{ route('employee.employees.index') }}">Employee List</a></li>
                    </ul>
                </li>

           <li><a href="#" class="waves-effect"><i class="icon-printer fa-fw"></i> <span class="hide-menu">Invoices </span></a> </li>

           <li><a href="#" class="waves-effect"><i class="icon-docs fa-fw"></i> <span class="hide-menu">Admin FAQ </span></a> </li>

           <li><a href="#" class="waves-effect"><i class="fa fa-user fa-fw"></i> <span class="hide-menu">Super Admin </span></a> </li>
