                        ...
                        <div class="card">
							...
							@foreach($program as $companyprogram)
                                            <tr>
                                               ...
                                               <td> 
													<a href="./topcirculateview/{{$companyprogram->company}}/{{$companyprogram->audit_frequency}}" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn" data-toggle="tooltip" data-original-title="View and Update Audit Program" ><i class="ti-eye" aria-hidden="true"></i></a>
