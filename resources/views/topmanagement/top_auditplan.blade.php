                        ...
                        <div class="card">
							...
							@foreach($plan as $companyplan)
                                            <tr>
                                                ...
                                                @endif
                                                 <td><a href="./top_planview/{{ Auth::user()->company_id }}/{{$companyplan->audit_number}}" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn" data-toggle="tooltip" data-original-title="View and Edits Audit Plan"><i class="ti-eye" aria-hidden="true"></i></a> </td> 
