...
@section('content')
 <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Audit Program List</h4>
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="10">
                                        ...
                                        <tbody>
							@foreach($audit as $companyprogram)
                                            <tr>
                                                <td>{{$sno++}}</td>
  ...
  {{$companyprogram->comment}}</td>
                                               ...
                                               <td> 
													<a href="./approvedauditview/{{$companyprogram->company}}/{{$companyprogram->audit_frequency}}" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn" data-toggle="tooltip" data-original-title="View Audit Program"><i class="ti-eye" aria-hidden="true"></i></a>
													  </td>
