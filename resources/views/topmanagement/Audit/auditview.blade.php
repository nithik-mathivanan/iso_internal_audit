...
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="{{$companydepartment->audit_number}}" readonly>
                                          <div class="isotable4 ">
...
<?php $radio=$sno++; ?>
                                    ...
                                    <td  style="display:none"> <input type="text" name="id[<?php echo $radio; ?>]" value="{{$companydepartment1->id}}"></td>
                                       <td class="border">
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="{{$companydepartment1->audit_number}}" readonly>
                                          <div class="isotable4 ">
...
<?php $radio=$sno++; ?>
                                     ...
                                     <td  style="display:none"> <input type="text" name="id[<?php echo $radio; ?>]" value="{{$companydepartment2->id}}"></td>
                                       <td class="border">
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none "  value="{{$companydepartment2->audit_number}}" readonly>
                                          <div class="isotable4 ">
...
<?php $radio=$sno++; ?>
                                    <tr class="border">
                                     <td  style="display:none"> <input type="text" name="id[<?php echo $radio; ?>]" value="{{$companydepartment3->id}}"></td>
                                       <td class="border">
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="{{$companydepartment3->audit_number}}" readonly>
                                          <div class="isotable4 ">
...
<?php $radio=$sno++; ?>
                                     ...
                                     <td style="display:none"> <input type="text" name="id[<?php echo $radio; ?>]"  value="{{$companydepartment4->id}}"></td>
                                       <td class="border">
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="{{$companydepartment4->audit_number}}" readonly>
                                          <div class="isotable4 ">
...
<button type="submit" class="btn btn-info" style="margin-left:25px;">CORRECT & APPROVED</button>
</form>  
...
<form action="{{ route('auditprogrampdf2') }}" style="display: inline-block;">
 ...
 <!-- Approve end-->
<!-- comment start-->
<form action="{{ route('comment') }}" method="post" style="margin-left: 25px;">
{{ csrf_field() }}  
<br/>
