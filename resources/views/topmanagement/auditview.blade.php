...
<form action="{{ route('topmanagementauditupdate') }}" method="post">
...
$audit_number=$companyscope->audit_number;
?>
@endforeach
...
<td class="border">
                                       ...
                                       <td style="border:solid 1px #000;">
                                          ...
                                          <div class="isotable20"><input type="text" name="remarks[<?php echo $radio; ?>]" class="remarks" value="{{$companydepartment->remarks}}"> </div>
...
<td class="border">
                                       ...
                                       <td style="border:solid 1px #000;">
                                          ...
                                          <div class="isotable20"><input type="text" name="remarks[<?php echo $radio; ?>]" class="remarks" value="{{$companydepartment1->remarks}}"> </div>
                                          <div class="isotable20"> </div>
...
<td class="border">
                                       ...
                                       <td style="border:solid 1px #000;">
                                          ...
                                          <div class="isotable20"><input type="text" name="remarks[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment2->remarks}}"> </div>
                                          <div class="isotable20"> </div>
...
<td class="border">
                                       ...
                                       <td style="border:solid 1px #000;">
                                          ...
                                          <div class="isotable20"><input type="text" name="remarks[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment3->remarks}}"> </div>
                                          <div class="isotable20"> </div>
...
<td class="border">
                                       ...
                                       <td style="border:solid 1px #000;">
                                          ...
                                          <div class="isotable20"><input type="text" name="remarks[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment4->remarks}}"> </div>
                                          <div class="isotable20"> </div>
...
<input type="text" name="draft" value="<?php echo $draft; ?>" style="display:none"> 
<input type="text" name="monthstart" value="<?php echo $monthstart; ?>" style="display:none"> 
<input type="text" name="monthend" value="<?php echo $monthend; ?>" style="display:none"> 

<button type="submit" class="btn btn-info" style="margin-left:25px;">CORRECTED & APPROVED</button>
</form>  
...
<!-- Approve start-->
<form action="{{ route('approve') }}" method="post" style="display:contents">
{{ csrf_field() }}  

<input type="text" name="monthstart" value="<?php echo $monthstart; ?>" style="display:none"> 
<input type="text" name="monthend" value="<?php echo $monthend; ?>" style="display:none"> 

<input type="text" name="status1" value="<?php echo $status; ?>"  style="display:none">  
<input type="text" name="draft" value="<?php echo $draft; ?>"  style="display:none">  
<input type="text" name="frequency" value="<?php echo $frequency; ?>" style="display:none"> 
<input type="text" name="companyid" value="<?php echo $company; ?>"  style="display:none">  
...
{{ csrf_field() }}  
<br/>
<input type="text" name="program_id" value="
@foreach($auditprogram as $companydepartment)
{{$companydepartment->id}},
@endforeach
"  style="display:none">
<input type="text" name="audit_number" value="<?php echo $audit_number; ?>" style="display:none"> 
<input type="text" name="frequency" value="<?php echo $frequency; ?>" style="display:none"> 
<input type="text" name="companyid" value="<?php echo $company; ?>"  style="display:none">  
...
<input type="text" name="monthend" value="<?php echo $monthend; ?>"   style="display:none"> 
<input type="text" name="draft" value="<?php echo $draft; ?>"   style="display:none"> 
<button type="submit" class="btn btn-info">COMMENT</button></form><br/> <br/> 
