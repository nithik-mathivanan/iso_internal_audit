			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						...
						<a href="{{ route('newdocument') }}" class="btn btn-info btn-rounded" style="float:right">Add New Document
						</a>
							...
							<table id="document-grid" class="table m-t-30 table-hover contact-list" data-page-size="10">
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="./documentedit/{{$documentupload->id}}" class="" data-toggle="tooltip" data-original-title="Edit" onclick="return confirm('Are you sure, You want to Edit this?');">Revise Doc?</a></td>
