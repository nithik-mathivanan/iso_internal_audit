				...
				<div class="card">
					<div class="card-body">
						...
						<div class="table-responsive">
							...
							@endif
							<form class="m-t-40"   method="POST" action="{{ route('documentstore') }}" enctype="multipart/form-data">
								@csrf
								...
								<div class="form-group">
									...
									<div class="controls">
										 <input type="text" name="shortname" class="form-control" value="{{old('shortname') }}" > 
										 <div class="help-block"></div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="controls">
										 <input type="file" name="document_template" class="form-control" value="" > 
										 <div class="help-block"></div>
									</div>
								</div>
								<div class="form-group">
