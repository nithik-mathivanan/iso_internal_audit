...
@endif
<form action="{{ route('auditstore') }}" method="post">
...
<?php $radio=$sno++; ?>
                                     <tr class="border">
                                       ...
                                       <td class="border">
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="IA-<?php echo $monthstart; ?>-<?php echo $monthhalf; ?>-001" readonly>
                                          <div class="isotable4 ">
                                             <p> <input type="text" name="audit_dept[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment->name}}" readonly> </p>
                                          </div>
...
<?php $radio=$sno++; ?>
                                     <tr class="border">
                                       ...
                                       <td class="border">
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="IA-<?php echo $monthhalf1; ?>-<?php echo $monthend; ?>-002" readonly>
                                          <div class="isotable4 ">
                                             <p> <input type="text" name="audit_dept[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment->name}}" readonly> </p>
                                          </div>
...
<?php $radio=$sno++; ?>
                                      <tr class="border">
                                       ...
                                       <td class="border">
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="IA-<?php echo $monthstart; ?>-<?php echo $monthquater1; ?>-001" readonly>
                                          <div class="isotable4 ">
                                             <p> <input type="text" name="audit_dept[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment->name}}" readonly> </p>
                                          </div>
...
<?php $radio=$sno++; ?>
                                     <tr class="border">
                                       ...
                                       <td class="border">
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="IA-<?php echo $monthquater11; ?>-<?php echo $monthquater2; ?>-002" readonly>
                                          <div class="isotable4 ">
                                             <p> <input type="text" name="audit_dept[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment->name}}" readonly> </p>
                                          </div>
...
<?php $radio=$sno++; ?>
                                    <tr class="border">
                                       ...
                                       <td class="border">
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="IA-<?php echo $monthquater21; ?>-<?php echo $monthquater3; ?>-003" readonly>
                                          <div class="isotable4 ">
                                             <p> <input type="text" name="audit_dept[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment->name}}" readonly> </p>
                                          </div>
...
<?php $radio=$sno++; ?>
                                      <tr class="border">
                                       ...
                                       <td class="border">
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="IA-<?php echo $monthquater31; ?>-<?php echo $monthend; ?>-004" readonly>
                                          <div class="isotable4 ">
                                             <p> <input type="text" name="audit_dept[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment->name}}" readonly> </p>
                                          </div>
