...
@endforeach
 ...
 <div class="container-fluid">
						...
						<div class="col-12">
							<div class="card" >
								<div class="card-body" ><div  id="reportPrinting">
									<h4 class="card-title"> Title : AUDIT PROGRAM</h4>
									<h6 class="card-subtitle">Status: {{$status}}{{$draft}}</h6>
...
?>
  <h5 style="line-height: 18px;    font-size: 20px;    text-align: center; font-weight: 400;"><?php echo "From: ".$monthstart; ?> TO <?php echo $monthend; ?></h5>
<?php
if ($frequency=='annual'){
										...
										<table class="table color-table success-table" style="font-size:10px; ">
											<thead class="border">
												<tr>
													...
													<th class="classtest" style="padding: 5px;border:1px solid black !important">Process/ Dept /Location</th>
													<th class="classtest" style="border:1px solid black !important;padding: 5px;">P/A</th>
													<th class="isotable2" style="border:1px solid black !important;padding: 5px;"><span > <?php echo $month1; ?>  </span></th>
													<th class="isotable2" style="border:1px solid black !important;padding: 5px;"><span > <?php echo $month2; ?>  </span></th>
													<th class="isotable2" style="border:1px solid black !important;padding: 5px;"><span > <?php echo $month3; ?>  </span></th>
													<th class="isotable2" style="border:1px solid black !important;padding: 5px;"><span > <?php echo $month4; ?>  </span></th>
													<th class="isotable2" style="border:1px solid black !important;padding: 5px;"><span > <?php echo $month5; ?>  </span></th>
													<th class="isotable2" style="border:1px solid black !important;padding: 5px;"><span > <?php echo $month6; ?>  </span></th>
													<th class="isotable2" style="border:1px solid black !important;padding: 5px;"><span > <?php echo $month7; ?>  </span></th>
													<th class="isotable2" style="border:1px solid black !important;padding: 5px;"><span > <?php echo $month8; ?>  </span></th>
													<th class="isotable2" style="border:1px solid black !important;padding: 5px;"><span > <?php echo $month9; ?>  </span></th>
													<th class="isotable2" style="border:1px solid black !important;padding: 5px;"><span > <?php echo $month10; ?>  </span></th>
													<th class="isotable2" style="border:1px solid black !important;padding: 5px;"><span > <?php echo $month11; ?>  </span></th>
													<th class="isotable2" style="border:1px solid black !important;padding: 5px;"><span > <?php echo $month12; ?>  </span></th>
...
<tr class="border" style="text-align :center;"><td  colspan="16" class="border audit_num" > Audit Number: <?php echo "IA-".$monthstart; ?>-<?php echo $monthend; ?></td></tr>
...
<?php $radio=$sno++; ?>
	<tr class="border">
			...
			<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="IA-<?php echo $monthstart; ?>-<?php echo $monthend; ?>" readonly style="display: none">
			<div class="isotable4 " style="">
			<p> <input type="text" name="audit_dept[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment->department}}" readonly style="border: none;"> </p>
			</div>
			...
			<td style="border:solid 1px #000;display:none">
...
<?php $radio=$sno++; ?>
                                    ...
                                    <td  style="display:none"> <input type="text" name="id[<?php echo $radio; ?>]" value="{{$companydepartment1->id}}"></td>
                                       <td class="border" >
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="{{$companydepartment1->audit_number}}" readonly style="display: none">
                                          <div class="isotable4 " >
                                             <p> <input type="text" name="audit_dept[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment1->department}}" readonly  style="border: none;"> </p>
                                          </div>
...
<?php $radio=$sno++; ?>
                                     ...
                                     <td  style="display:none"> <input type="text" name="id[<?php echo $radio; ?>]" value="{{$companydepartment2->id}}"></td>
                                       <td class="border">
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none "  value="{{$companydepartment2->audit_number}}" readonly style="display: none">
                                          <div class="isotable4 ">
                                             <p> <input type="text" name="audit_dept[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment2->department}}" readonly  style="border: none;"> </p>
                                          </div>
...
<?php $radio=$sno++; ?>
												 ...
												 <td  style="display:none"> <input type="text" name="id[<?php echo $radio; ?>]"value="{{$companydepartment1->id}}"></td>
													<td class="border">
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="IA-<?php echo $monthstart; ?>-<?php echo $month1; ?>" readonly style="display: none">
														<div class="isotable4 " >
															<p> <input type="text" name="audit_dept[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment1->department}}" readonly style="border: none;"> </p>
														</div>
...
<td class="border">
															...
															<div class="isotable16"><label class="custom-control custom-radio   isotable6 "></label></div>
...
<?php $radio=$sno++; ?>
												 ...
												 <td style="display:none"> <input type="text" name="id[<?php echo $radio; ?>]"  value="{{$companydepartment2->id}}"></td>
													<td class="border">
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="IA-<?php echo $monthquater11; ?>-<?php echo $month2; ?>" readonly style="display: none">
														<div class="isotable4 " >
															<p> <input type="text" name="audit_dept[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment2->department}}" readonly style="border: none;"> </p>
														</div>
...
<?php $radio=$sno++; ?>
												<tr class="border">
												 <td  style="display:none"> <input type="text" name="id[<?php echo $radio; ?>]" value="{{$companydepartment3->id}}"></td>
													<td class="border">
{{csrf_field()}}
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="IA-<?php echo $monthquater21; ?>-<?php echo $month3; ?>" readonly style="display: none">
														<div class="isotable4 ">
															<p> <input type="text" name="audit_dept[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment3->department}}" readonly style="border: none;"> </p>
														</div>
...
<td class="border">
													...
													<td style="border:solid 1px #000;display: none;">
														...
														<div class="isotable20" style="display: none"><input type="text" name="remarks[<?php echo $radio; ?>]" class="remarks"> </div>
														<div class="isotable20"> </div>
...
<input type="text" name="audit_num[<?php echo $radio; ?>]" class="remarks none"  value="IA-<?php echo $monthquater31; ?>-<?php echo $monthend; ?>" readonly>
														<div class="isotable4 ">
															<p> <input type="text" name="audit_dept[<?php echo $radio; ?>]" class="remarks"  value="{{$companydepartment4->department}}" readonly style="border: none;"> </p>
														</div>
...
?>
									...
									<button type="submit" class="btn btn-info">Send for Approval</button> 
</form> 
