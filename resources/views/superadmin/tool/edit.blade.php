	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">Modules Edit</div>
				<div class="panel-wrapper collapse in" aria-expanded="true">
					<div class="panel-body">
					   <form method="POST" action="{{route('updatemodules',['id'=>$tools->id])}}">
						@csrf
						@method('PUT')
							<div class="form-body">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" id="name" name="name" value="{{ $tools->name ?? '' }}" class="form-control" >
											  @if($errors->has('name'))
								   ...
								   <div class="col-md-6 ">
										<div class="form-group">
											...
											<input type="number" name="price" id="price"  value="{{ $tools->price ?? '' }}"   class="form-control">
											@if($errors->has('price'))
											<span class="invalid-feedback">
