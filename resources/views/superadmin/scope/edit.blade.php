	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">Scope Edit</div>
				<div class="panel-wrapper collapse in" aria-expanded="true">
					<div class="panel-body">
					   <form method="POST" action="{{route('updatescope',['id'=>$scope->id])}}">
						@csrf
						@method('PUT')
							<div class="form-body">
								<div class="row">
									<div class="col-md-6 col-md-offset-3">
										<div class="form-group">
											...
											<input type="text" id="name" name="name" value="{{ $scope->name ?? '' }}" class="form-control" >
											  @if($errors->has('name'))
