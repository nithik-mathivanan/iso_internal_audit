	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">Standard Edit</div>
				<div class="panel-wrapper collapse in" aria-expanded="true">
					<div class="panel-body">
					   <form method="POST" action="{{route('updatestandard',['id'=>$standard->id])}}">
						@csrf
								...
								<div class="row">
									<div class="col-md-6 col-md-offset-3">
										<div class="form-group">
											...
											<input type="text" id="name" name="name" value="{{ $standard->name ?? '' }}" class="form-control" >
											  @if($errors->has('name'))
