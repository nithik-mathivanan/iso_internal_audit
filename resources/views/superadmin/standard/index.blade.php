...
<section>
	<div class="row bg-title">
		...
		<div class="col-lg-8 col-md-5 col-sm-6 col-xs-12">
			<h4 class="page-title">Standard</h4>
		</div>   
			 <div class="col-lg-4 col-sm-6 col-md-7 col-xs-12 text-right">
			<a href="{{ route('createstandard') }}"
			class="btn btn-outline btn-success btn-sm">Add Standard&nbsp;&nbsp; <i class="fa fa-plus" aria-hidden="true"></i></a>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
