...
Route::get('documentedit/{id}', "company\MRDocumentUploadController@documentedit")->name('documentedit');
Route::post('documentupdate', "company\MRDocumentUploadController@store")->name('documentupdate');
